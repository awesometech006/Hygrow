...
const WhatsAppButton = () => {
  ...
  return (
    <a 
      ...
      className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-50 p-3 sm:p-4 rounded-full bg-green-500 hover:bg-green-600 shadow-xl transition-all duration-300 transform hover:scale-110"
